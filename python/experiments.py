...
def prepare_results_for_visualization(df: pd.DataFrame, id_vars: list=["graph_model", "protocol", "adversary_ratio", "adversary_type", "estimator", "broadcast_mode"]) -> pd.DataFrame:
